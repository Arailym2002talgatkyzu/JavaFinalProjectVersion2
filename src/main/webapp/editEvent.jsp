...
<div class="container container-login" style = "margin-top: 10px; color: #fff;">
    <div class="col-md-8" style="margin-left: 150px">
        <form method="post" action="editEvent">
            <h3 style="background-color: rgba(255, 61, 61, 0.568); height: 50px; text-align: center; padding: 5px"><b>Edit Event</b></h3>
            <div class="form-group">
                <label for="exampleInputEmail">ID</label>
                <input type="text" name="id" class="form-control" id="exampleInputEmail">
            </div>
            <div class="form-group">
